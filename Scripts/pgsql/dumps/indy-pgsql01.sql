...
CREATE ROLE "Indy_Jenkins_Luigi-DB";
ALTER ROLE "Indy_Jenkins_Luigi-DB" WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS;
...
CREATE ROLE indy_jenkins_luigi_db;
ALTER ROLE indy_jenkins_luigi_db WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS;
...
GRANT luigi_reader TO "Indy_Jenkins_Luigi-DB" GRANTED BY "ben.wyatt";
...
GRANT luigi_reader TO indy_jenkins_luigi_db GRANTED BY "ben.wyatt";
