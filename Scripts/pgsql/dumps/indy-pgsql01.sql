...
CREATE ROLE indy_jenkins_luigi;
ALTER ROLE indy_jenkins_luigi WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS;
...
GRANT luigi_reader TO indy_jenkins_luigi GRANTED BY "ben.wyatt";
