...
CREATE ROLE "Indy_ePHI_0032OSD";
ALTER ROLE "Indy_ePHI_0032OSD" WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
...
GRANT ldap_groups TO "Indy_ePHI_0032OSD" GRANTED BY postgres;
