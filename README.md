...
This folder contains one script for each PostgreSQL server, which can be used to reconstruct the structure of a server's databases as well as user/group roles and their privileges. Use git blame to track down when a change was made.
...
**These files should not be directly edited. Any changes you make will be overwritten the next time the Jenkins job runs.**
